...
curl -X PUT 'localhost:9200/_template/char_filters' -d @templates/char_filters.json
...
curl -X PUT 'localhost:9200/_template/streams_keyword_analyzer' -d @templates/streams_keyword_analyzer.json
...
curl -X PUT 'localhost:9200/_template/streams_tag_analyzer' -d @templates/streams_tag_analyzer.json
